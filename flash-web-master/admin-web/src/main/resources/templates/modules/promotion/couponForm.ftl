		...
		$(document).ready(function() {
			$("#inputForm").validate({
				rules: {
					...
					percentageOfDiscount: {required:true,digits:true,min:1},
				...
				messages: {
					...
					percentageOfDiscount:{ required:"please enter	"},
			...
			<@form.form id="inputForm" modelAttribute="obj" action="${ctx}/sys/pro/saveCoupon" method="post" class="form-horizontal">
				...
				<@tags.message content=message! />
				 <div class="form-body">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><@spring.message code="PercentageOfDiscount"></@spring.message>:</label>
						<div class="col-md-4">
							<input type="text" name="percentageOfDiscount" value="${obj.percentageOfDiscount!'1'}" maxlength="50"  class="form-control required"/>
						</div>
					</div>
					
				 	
					<div class="form-group">
						<label class="col-md-3 control-label"><@spring.message code="Upto Amount "></@spring.message>:</label>
						<div class="col-md-4">
