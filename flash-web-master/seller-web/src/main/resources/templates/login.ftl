...
<head lang="en">
    <meta charset="UTF-8">
    <title><@spring.message code="merchant.productName"></@spring.message></title>
...
<div class="login-wrap">
    <div class="text-center pb-20" style="margin-top:80px;"><span style="font-size:30px;color:white;"><@spring.message code="merchant.productName"></@spring.message></span></div>
    <div class="login-panel" >
        <div class="login-box">
            <div class="title"><@spring.message code="merchant.login"></@spring.message></div>
            <form class="login-form" id="loginForm" action="/login" method="post">
                <div class="item">
                    <span><@spring.message code="merchant.account"></@spring.message></span>
                    <input type="text" class="txt" id="username" name="username" />
                </div>
                <div class="item">
                    <span><@spring.message code="merchant.password"></@spring.message></span>
    ...
    <div class="login-copyright"><@spring.message code="merchant.copyright"></@spring.message></div>
</div>
<script>
