...
import vc.thinker.cabbage.web.security.SellerAuthorizingRealm;
...
public class ShiroConfig {
	...
	public org.apache.shiro.mgt.SecurityManager securityManager(SellerAuthorizingRealm systemAuthorizingRealm) {
	...
	@Bean
	public SellerAuthorizingRealm systemAuthorizingRealm(CountValidateCodeHandler validateCodeHandler){
		SellerAuthorizingRealm adminAuthorizingRealm=new SellerAuthorizingRealm();
