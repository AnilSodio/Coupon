...
public class UserCouponDao {
	 ...
	 * @return
	 */
	public UserCouponBO findOneByGteAmount(Long uid,BigDecimal amount,Integer percentageOfDiscount,String currency,String name,String cityId){
		UserCouponExample example=new UserCouponExample();
	 ...
	 * 查找小于该金额的最大优惠劵
	 * @param amount
	 * @param percentageOfDiscount 
	 * @param cityId
	 * @return
	 */
	public UserCouponBO findOneByLteAmount(Long uid, BigDecimal amount, Integer percentageOfDiscount, String currency,
			String cityId){
		UserCouponExample example=new UserCouponExample();
