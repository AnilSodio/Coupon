...
import vc.thinker.cabbage.web.security.AgentAuthorizingRealm;
...
public class ShiroConfig {
	...
	public org.apache.shiro.mgt.SecurityManager securityManager(AgentAuthorizingRealm systemAuthorizingRealm) {
	...
	@Bean
	public AgentAuthorizingRealm systemAuthorizingRealm(CountValidateCodeHandler validateCodeHandler){
		AgentAuthorizingRealm adminAuthorizingRealm=new AgentAuthorizingRealm();
