					...
					<li class="dropdown dropdown-user">
						...
						<ul class="dropdown-menu dropdown-menu-default">
							<li>
								...
								<i class="icon-user"></i>&nbsp; <@spring.message code="agent.index.info"></@spring.message></a>
							</li>
							<li>
								<a target="mainFrame" href="${ctx}/modifyPwd">
								<i class="icon-lock"></i>&nbsp; <@spring.message code="agent.index.modifyPwd"></@spring.message></a>
							</li>
							<li>
								<a target="mainFrame"  href="${ctx}/logout">
								<i class="icon-key"></i>&nbsp; <@spring.message code="agent.index.logout"></@spring.message></a>
							</li>
						</ul>
					</li>
				...
				<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <#--会员 -->
	                    <li>
	                        <a href="javascript:;">
		                        ...
		                        <span class="title">&nbsp;<@spring.message code="agent.index.cabinetList"></@spring.message></span>
		                        <span class="arrow "></span>
	                        </a>
	                        <ul class="sub-menu">
	                            <li class="active">
	                                <a target="mainFrame" href="${ctx}/cabinet/list">
	                                &nbsp;<@spring.message code="agent.index.cabinetList"></@spring.message>
	                                </a>
	                            </li>
	                        </ul>
	                    </li>
                    ...
                    <li>
	                        <a href="javascript:;">
		                        ...
		                        <span class="title">&nbsp;<@spring.message code="agent.index.orderTitle"></@spring.message></span>
		                        <span class="arrow "></span>
	                        </a>
	                       <ul class="sub-menu">
	                            <li>
	                                <a target="mainFrame" href="${ctx}/order/list">
	                              	 &nbsp;<@spring.message code="agent.index.orderList"></@spring.message>
	                                </a>
	                            </li>
	                        </ul>
	                    </li>
					...
					<li>
                        <a href="javascript:;">
                        <i class="icon-note"></i>
                        <span class="title">&nbsp;<@spring.message code="agent.index.incomeTitle"></@spring.message></span>
                        <span class="arrow "></span>
                        </a>
                        <ul class="sub-menu">
                            ...
                            <li>
                                ...
                                &nbsp;<@spring.message code="agent.index.moneyLogs"></@spring.message>
                                </a>
                            </li>
                        </ul>
                    </li>
