...
<div class="portlet light ">
    ...
    <div class="portlet-title">
        <div class="caption">
            <span class="caption-subject font-green bold"><@spring.message code="agent.revenue.statistics"></@spring.message></span>
        </div>
    </div>
    ...
    <div class="portlet-body form">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin-bottom-10" style="width:300px;">
                <div class="dashboard-stat blue-madison">
                    ...
                    <div class="details">
                       ...
                       ${total!0}
                        ...
                        <div class="desc">
                        	<@spring.message code="agent.revenue.total"></@spring.message>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="width:300px;">
                <div class="dashboard-stat red">
                    ...
                    <div class="details">
                        ...
                        <div class="desc">
                        	<@spring.message code="agent.revenue.today"></@spring.message>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="width:300px;">
                <div class="dashboard-stat yellow">
                    ...
                    <div class="details">
                        ...
                        <div class="desc">
                            	<@spring.message code="agent.revenue.yesterday"></@spring.message>
                        </div>
                    </div>
                </div>
            </div>
			...
			<div>
            	&nbsp;&nbsp;&nbsp;
            	 <@form.select id="statsType" path="statsType" class="select2 form-control input-small">
            	 	<@form.option value="1"><@spring.message code="agent.revenue.dailyStatistics"></@spring.message></@form.option>
            	 	<@form.option value="2"><@spring.message code="agent.revenue.monthlyStatistics"></@spring.message></@form.option>
            	 </@form.select>
            	 &nbsp;&nbsp;&nbsp;
