...
public class UserCouponService {
	 ...
	 * @return
	 */
	public UserCouponBO findFitCoupon(Long uid,BigDecimal amount,Integer percentageOfDiscount,String currency,String name,String cityId){
		UserCouponBO coupon=userCouponDao.findOneByGteAmount(uid,amount,percentageOfDiscount, currency,name,cityId);
		if(coupon == null){
		}
		return coupon;
	}
